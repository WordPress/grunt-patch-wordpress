...
module.exports = function(grunt) {
    ...
    var map_object_includes = {
        ...
        'build/wp-includes/js/media/controllers/audio-details.js' : './src/js/media/controllers/audio-details.js',
        'build/wp-includes/js/media/controllers/collection-add.js' : './src/js/media/controllers/collection-add.js',
        'build/wp-includes/js/media/controllers/collection-edit.js' : './src/js/media/controllers/collection-edit.js',
        'build/wp-includes/js/media/controllers/cropper.js' : './src/js/media/controllers/cropper.js',
        'build/wp-includes/js/media/controllers/customize-image-cropper.js' : './src/js/media/controllers/customize-image-cropper.js',
        'build/wp-includes/js/media/controllers/edit-attachment-metadata.js' : './src/js/media/controllers/edit-attachment-metadata.js',
        'build/wp-includes/js/media/controllers/edit-image.js' : './src/js/media/controllers/edit-image.js',
        'build/wp-includes/js/media/controllers/embed.js' : './src/js/media/controllers/embed.js',
        'build/wp-includes/js/media/controllers/featured-image.js' : './src/js/media/controllers/featured-image.js',
        'build/wp-includes/js/media/controllers/gallery-add.js' : './src/js/media/controllers/gallery-add.js',
        'build/wp-includes/js/media/controllers/gallery-edit.js' : './src/js/media/controllers/gallery-edit.js',
        'build/wp-includes/js/media/controllers/image-details.js' : './src/js/media/controllers/image-details.js',
        'build/wp-includes/js/media/controllers/library.js' : './src/js/media/controllers/library.js',
        'build/wp-includes/js/media/controllers/media-library.js' : './src/js/media/controllers/media-library.js',
        'build/wp-includes/js/media/controllers/region.js' : './src/js/media/controllers/region.js',
        'build/wp-includes/js/media/controllers/replace-image.js' : './src/js/media/controllers/replace-image.js',
        'build/wp-includes/js/media/controllers/site-icon-cropper.js' : './src/js/media/controllers/site-icon-cropper.js',
        'build/wp-includes/js/media/controllers/state-machine.js' : './src/js/media/controllers/state-machine.js',
        'build/wp-includes/js/media/controllers/state.js' : './src/js/media/controllers/state.js',
        'build/wp-includes/js/media/controllers/video-details.js' : './src/js/media/controllers/video-details.js',

        'build/wp-includes/js/media/models/attachment.js' : './src/js/media/models/attachment.js',
        'build/wp-includes/js/media/models/attachments.js' : './src/js/media/models/attachments.js',
        'build/wp-includes/js/media/models/post-image.js' : './src/js/media/models/post-image.js',
        'build/wp-includes/js/media/models/post-media.js' : './src/js/media/models/post-media.js',
        'build/wp-includes/js/media/models/query.js' : './src/js/media/models/query.js',
        'build/wp-includes/js/media/models/selection.js' : './src/js/media/models/selection.js',

        'build/wp-includes/js/media/routers/manage.js' : './src/js/media/routers/manage.js',

        'build/wp-includes/js/media/utils/selection-sync.js' : './src/js/media/utils/selection-sync.js',
    }

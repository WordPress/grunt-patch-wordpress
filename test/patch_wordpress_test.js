	...
	describe( 'map_old_to_new_file_path', function() {
		...
		describe('old to new', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_1_copy.diff", file_mappings);
			});
		...
		describe('new stay unchanged', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_2_copy.diff", file_mappings);
			});
		...
		describe('unknown stay unchanged', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_3_copy.diff", file_mappings);
			});
		...
		describe('new stay unchanged, old to new', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_4_copy.diff", file_mappings);
			});
		...
		describe('new and unknown stay unchanged', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_5_copy.diff", file_mappings);
			});
		...
		describe('new and unknown stay unchanged, old to new', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_6_copy.diff", file_mappings);
			});
		...
		describe('non-src old to new', function () {
			before(function () {
				...
				map_old_to_new_file_path("./test/tmp/patch_wordpress_7_copy.diff", file_mappings);
			});
